...
class SpectreSamplingMetrics(nn.Module):
    ...
    def forward(self, generated_graphs: list, name, current_epoch, val_counter, local_rank, test=False):
        ...
        if 'sbm' or 'planar' in self.metrics_list:
            ...
            print("Fraction unique: ", frac_unique)
            print("Fraction unique non-isomorphic: ", frac_unique_non_isomorphic)
            print("Fraction unique non-isomorphic valid: ", fraction_unique_non_isomorphic_valid)
            print("Fraction non-isomorphic: ", frac_non_isomorphic)
